...
- (void)initMapView
{
    ...
    location.latitude=43.85201;
    location.longitude = 125.296;
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    index = NO;
    self.navigationController.toolbarHidden = index;
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationController.toolbar.backgroundColor = [UIColor colorWithRed:0.807 green:0.883 blue:0.932 alpha:0.000];
    [self.navigationController setToolbarHidden:index animated:animated];
}
